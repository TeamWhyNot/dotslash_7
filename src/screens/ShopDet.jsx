        ...
        <div className='h-[100vh] w-[100vw] flex items-center justify-start overflow-hidden'>
            ...
            <div className='h-[100vh] w-[100%] flex-col space-y-2 ml-10 items-start justify-start '>
                ...
                <div>
                    ...
                    <h1>LET’S SETUP YOUR PROFILE!! Get set go..</h1>
                </div>
                <div>
                    ...
                    <div className='bg-[#FAFAFA] p-4 rounded-md  w-[80%] space-y-4 h-[72%]'>
                        <div className='flex  w-[100%] justify-center items-center'>
                            <div className='space-y-2 w-[100%] '>
                                ...
                                <div className='w-[100%]'>
                                    <input onChange={handleChange} className='w-[100%] border-solid border-[1px] rounded-md p-2' type='text' name='shopName' placeholder='Enter Shop Name'></input>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='flex  w-[100%] justify-center items-center'>
                            <div className='space-y-2 w-[100%] '>
                                ...
                                <div className='w-[100%]'>
                                    <select onChange={handleChange} className='w-[100%] border-solid border-[1px] rounded-md p-2' name='category' type='text' placeholder='Enter Category'>
                        ...
                        <div className='flex  w-[100%] justify-center items-center'>
                            <div className='space-y-2 w-[100%] '>
                                ...
                                <div className='w-[100%]'>
                                    <textarea onChange={handleChange} className='w-[100%] h-[100px] border-solid border-[1px] rounded-md p-2' name='location' type='text' placeholder='Write full address of your Shop'></textarea>
                                </div>
                            </div>
                        </div>
                        <div className='flex  w-[100%] justify-center items-center'>
                            <div className='space-y-2 w-[100%] '>
                                ...
                                <div className='w-[100%]'>
                                    <input onChange={handleChange} className='w-[100%] border-solid border-[1px] rounded-md p-2' type='text' name='description' placeholder='Tell about your shop'></input>
                                </div>
                            </div>
                        </div>
