  ...
  return (
    <div>
            ...
            <div className="flex justify-center items-center  gap-16 m-auto p-auto">
                ...
                <div className="container grid  ">
                    <div className="  flex justify-end h-full">
                        <div className="logincard flex-col bg-white rounded-[1.25rem] w-[33rem] mt-[10%] gap-[5rem] h-[30rem] flex items-center  p-4">
                            <h1 className=' font-bold text-[1.5rem]'>Login to Your Account</h1>
                  ...
                  />
                            ...
                            <Button onClick={handleLogin} className="w-[80%] h-[2.5rem]">Continue</Button> 
                        </div>
                    </div>
        ...
        <div className="flex flex-col h-auto w-full ">
            ...
            <h1 className=' font-bold text-[3rem] leading-normal'>Login </h1>
            <h1 className='font-bold text-[3rem] leading-normal'>to Account</h1>
